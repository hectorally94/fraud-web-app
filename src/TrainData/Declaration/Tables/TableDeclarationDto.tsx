...
import ServiceReportClassification from "../../../Analysis/Scan/Services/ServiceReportClassification";
import DeclarationDto from "../Models/DeclarationDto";
import ServiceDeclarationDto from "../Services/ServiceDeclarationDto";


export const TableDeclarationDto=()=> {

  const [mytableData, setMytableData] = useState<Array<DeclarationDto>>([]);
      ...
      <Table>
          <TableHead>
            <TableRow >
              ...
              <TableHeaderCell className="text-right">Turnover Declared</TableHeaderCell>
